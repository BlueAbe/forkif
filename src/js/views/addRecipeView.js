...
class addRecipeView extends View {
  ...
  constructor() {
    super(); //must be super if  we wonna use this keyword
  ...
  hideWindow() {
    ...
    setTimeout(this.render.bind(this), 300, { empty: 'object' }); //some trick with this object to give some data
  }
  ...
  addHandlerUpload(handler) {
    this._parentElement.addEventListener('submit', function (e) {
      e.preventDefault();
      const dataArr = [...new FormData(this)]; //array from form field
